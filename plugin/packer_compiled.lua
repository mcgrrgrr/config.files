...
_G.packer_plugins = {
  ...
  ["melange-nvim"] = {
    loaded = true,
    path = "/home/ian/.local/share/nvim/site/pack/packer/start/melange-nvim",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/ian/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
  ...
  ["vim-be-good"] = {
    loaded = true,
    path = "/home/ian/.local/share/nvim/site/pack/packer/start/vim-be-good",
